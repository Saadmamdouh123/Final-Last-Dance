<x-app-layout>
    <div class="p-8">
        <div class="flex justify-center items-center pt-7">
            <img width="100px" class=" right-6 bottom-[390px] bg-yellow-400 rounded-lg"
    ...
    <div class="flex flex-wrap p-10 items-center justify-center gap-8 shadow-xl shadow-gray-300 rounded-xl w-fit">
        @foreach ($showSessions as $show)
            <div class="flex gap-8 justify-center items-center">
                <div>
                    <img width="300px" class="rounded-lg"
                        src="https://i.pinimg.com/736x/fe/ac/95/feac95cb34ca3b9f5bad000a35896e48.jpg" alt="">
                </div>
                <div class="pb-6">
                    <h1 class="text-xl font-bold pb-1">{{ $show->name }}</h1>
                    <h2 class="pb-2 text-gray-700 text-lg">{{ $show->start_time }}</h2>
                    <h2 class="pb-2 text-gray-700 text-lg">{{ $show->end_time }}</h2>
                    ...
                    <div class="pt-4">
                        <button aria-label="Start Game"
                            ...
                            id="startButton">
                            <a class="text-black" href="{{ route('dashboard') }}">dashboard</a>
                        </button>
                    </div>
                </div>
            </div>
