<x-app-layout>
    @if (Auth::user()->hasRole('coach'))
        @if (session('success'))
            <div id="alert-box"
                ...
                <button type="button" class="absolute top-0 bottom-0 right-0 px-4 py-3 text-green-800"
            ...
            <div class="bg-black relative">
                <div class="bg-black relative">
                    ...
                    <div class="absolute top-40 left-16">
                        ...
                        <p class="text-gray-400 pb-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. <br> Unde
                            sit
        ...
        <script>
            document.addEventListener('DOMContentLoaded', async function() {
                let response = await axios.get("/session/createe")
    ...
    @else
    <div class="relative h-screen overflow-hidden bg-slate-400">
        <!-- Video Background -->
        <video autoplay muted loop class="absolute top-0 left-0 w-full h-full object-cover">
            <source src="https://videos.pexels.com/video-files/3191884/3191884-uhd_2560_1440_25fps.mp4" class="opacity-70" type="video/mp4">
            Your browser does not support the video tag.
        </video>
    
        <!-- Content Overlay -->
        <div class="relative z-10 flex flex-col justify-center items-center h-full bg-black/50">
            <p class="text-2xl pb-5 text-white">You Should Make a Request to Become a Coach</p>
